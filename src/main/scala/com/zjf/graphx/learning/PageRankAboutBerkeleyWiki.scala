...
object PageRankAboutBerkeleyWiki {
  def main(args: Array[String]) {
    ...
    //读入数据文件
    val articles: RDD[String] = sc.textFile("/Users/zhangjianfeng/workspaces/workspace_github_bg/my-spark-graphx/data/graphx-wiki-vertices.txt")
    val links: RDD[String] = sc.textFile("/Users/zhangjianfeng/workspaces/workspace_github_bg/my-spark-graphx/data/graphx-wiki-edges.txt")
